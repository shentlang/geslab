      ...
      <div class="col-12">
        ...
        <div class="card">
          ...
          <div class="card-header">
            <h3 class="card-title">lista de decanos</h3>
            <p class="float-right animated rotateInDownRight slow"><a href="{{ route('decano.create') }}" class="btn btn-outline-primary">Registrar nuevo decano</a></p>
