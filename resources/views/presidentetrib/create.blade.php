              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select name="titulo" class="form-control" data-placeholder="Seleccione titulo"
                            style="width: 100%;">
                  ...
                  <div class="form-group">
                    <label> funcion</label>
                    <select name="funciond" class="form-control" data-placeholder="seleccione funcion" style="width: 100%;">
                      <option value="Dir. Informatica y Ciencias Exactas">Dir. Informatica y Ciencias Exactas</option>
                      <option value="Dir. Ciencias Economicas y Empresariales">Dir. Ciencias Economicas y Empresariales</option>
                      <option value="Dir. Ciencias Contables, Financieras y Economicas">Dir. Ciencias Contables, Financieras y Economicas</option>
                      <option value="Dir. Ciencias Agronomicas">Dir. Ciencias Agronomicas</option>
                    </select>
                  </div>
                      ...
                      <div class="modal-dialog">
                          <div class="modal-content bg-primary">
                              <div class="modal-header">
                                  <h4 class="modal-title">Desea Registrar Director dpto.?</h4>
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true">&times;</span></button>
                              </div>
                              <div class="modal-body">
                                  <p>el director se guardara en el Sis. Doc.&hellip;</p>
                              </div>
